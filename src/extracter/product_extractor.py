...
from spark_schema import product_crawl_schema


SCHEMA_FIELD_NAMES = [f.name for f in product_crawl_schema.product_crawl_schema.fields]
...
def extract_product_data(id_, html):
    ...
    try:
        ...
        return pd.DataFrame([{
            ...
            "productRateCount": None, "categoryTree": None, "brandOrigin": "",
...
parsed_df = html_df.mapInPandas(extract_batch, schema=product_crawl_schema.product_crawl_schema)
